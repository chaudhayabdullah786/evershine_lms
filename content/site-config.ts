...
export const SITE_CONFIG: SiteConfig = {
  ...
  bannerImages: [
    ...
    { src: '/assets/images/banner/banner-6.png', alt: 'Sports Today Champions Tomorrow — Annual Sports Day' },
    { src: '/assets/images/banner/banner-2.png', alt: 'Admission Open 2026 — Play Group to College' },
    { src: '/assets/images/banner/banner-4.png', alt: 'Equal Opportunities — Boys and Girls Campuses' },
  ],

  galleryImages: [
    // ── Original Gallery (physics lab & study sessions) ──────────────
    { src: '/assets/images/gallery/gallery-1.png', alt: 'Hands-on magnetic field experiment in Physics lab — Evershine Academy', orientation: 'landscape', caption: 'Physics Lab — Hands-On Learning' },
    { src: '/assets/images/gallery/gallery-2.png', alt: 'Students observing light refraction through a glass prism in science lab', orientation: 'landscape', caption: 'Optics Experiment' },
    { src: '/assets/images/gallery/gallery-3.png', alt: 'Students engaged in group study and collaborative learning session', orientation: 'landscape', caption: 'Collaborative Learning' },
    { src: '/assets/images/gallery/gallery-4.png', alt: 'Students engaged in practical Physics experiments at Evershine Academy', orientation: 'landscape', caption: 'Practical Physics' },
    { src: '/assets/images/gallery/gallery-5.png', alt: 'Intensive group study and exam preparation session at Evershine Academy', orientation: 'landscape', caption: 'Exam Preparation' },

    // ── NEW: High-Resolution Facility Photos (2026) ───────────────────
    { src: '/assets/images/gallery/gallery-6.png',  alt: 'ESA Parvaz Batch classroom with students seated at desks in neat rows — Evershine Academy', orientation: 'landscape', caption: 'Parvaz Batch Classroom' },
    { src: '/assets/images/gallery/gallery-7.png',  alt: 'Well-equipped Science Lab with laboratory equipment and workstations at Evershine Academy', orientation: 'landscape', caption: 'Science Laboratory' },
    { src: '/assets/images/gallery/gallery-8.png',  alt: 'Reception and administration area featuring an academic ranking and achievement board', orientation: 'landscape', caption: 'Administration & Rankings' },
    { src: '/assets/images/gallery/gallery-9.png',  alt: 'Bright classroom adorned with Islamic calligraphy and motivational dua banners at Evershine Academy', orientation: 'landscape', caption: 'Islamic Values Classroom' },
    { src: '/assets/images/gallery/gallery-10.png', alt: "Principal's office at Evershine Academy — a professional and welcoming administrative space", orientation: 'landscape', caption: "Principal's Office" },
    { src: '/assets/images/gallery/gallery-11.png', alt: 'Study and meeting room with whiteboard at Evershine Academy — supporting faculty collaboration', orientation: 'landscape', caption: 'Faculty Meeting Room' },
    { src: '/assets/images/gallery/gallery-12.png', alt: "Director's office at Evershine Academy — reflecting institutional leadership and vision", orientation: 'landscape', caption: "Director's Office" },
    { src: '/assets/images/gallery/gallery-13.png', alt: 'Parvaz Batch classroom interior showing organized student desks and learning environment', orientation: 'landscape', caption: 'Organized Learning Space' },
    { src: '/assets/images/gallery/gallery-14.png', alt: 'Close-up of Science Lab workstation with chemistry and physics equipment at Evershine Academy', orientation: 'landscape', caption: 'Lab Equipment Detail' },
    { src: '/assets/images/gallery/gallery-15.png', alt: 'Academic records and achievement archives at Evershine Academy administrative office', orientation: 'landscape', caption: 'Academic Records' },
    { src: '/assets/images/gallery/gallery-16.png', alt: 'Examination classroom set up with individual desks for board exam preparation at Evershine Academy', orientation: 'landscape', caption: 'Exam Hall' },
    { src: '/assets/images/gallery/gallery-17.png', alt: 'Batch 5 Mathematics classroom with students engaged in an active lesson at Evershine Academy', orientation: 'landscape', caption: 'Mathematics Class — Batch 5' },

    // ── Banner Images Repurposed as Gallery Cards ─────────────────────
    { src: '/assets/images/banner/banner-6.png', alt: 'Annual Sports Day at Evershine Academy — Speed, Strength, and Team Spirit', orientation: 'landscape', caption: 'Annual Sports Day' },
    { src: '/assets/images/banner/banner-1.png', alt: 'STEM Innovation Lab — Learn by Doing, Build for Tomorrow at Evershine Academy', orientation: 'landscape', caption: 'STEM Innovation Lab' },
    { src: '/assets/images/banner/banner-5.png', alt: 'Learn Today, Lead Tomorrow — Classroom Excellence at Evershine Academy', orientation: 'landscape', caption: 'Classroom Excellence' },
    { src: '/assets/images/banner/banner-4.png', alt: 'Separate Boys and Girls Campuses — Equal Opportunities at Evershine Academy', orientation: 'landscape', caption: 'Dual Campuses' },

    // ── NEW: Campus Life & Religious Education (June 2026) ────────────
    { src: '/assets/images/gallery/quran-class-boys.jpeg', alt: 'Boys Quran class session at Evershine Academy — students in green caps learning Islamic studies', orientation: 'landscape', caption: 'Quran Class — Boys Campus' },
    { src: '/assets/images/gallery/classroom-girls.jpeg', alt: 'Girls classroom learning session at ESA — active teaching environment', orientation: 'landscape', caption: 'Active Learning — Girls Campus' },
    { src: '/assets/images/gallery/outdoor-teaching.jpeg', alt: 'Interactive outdoor teaching session with teacher addressing students at Evershine Academy', orientation: 'landscape', caption: 'Interactive Teaching Session' },
    { src: '/assets/images/gallery/dars-e-nizami.jpeg', alt: 'Dars-e-Nizami lecture session — Islamic studies classroom at Evershine Academy', orientation: 'landscape', caption: 'Dars-e-Nizami Session' },
  ],

  videos: [
    {
      src: '/assets/videos/sports-day.mp4',
      poster: '/assets/images/banner/banner-6.png',
      title: 'Annual Sports Day — Gulshan Iqbal Park',
      orientation: 'landscape',
    },
    {
      src: '/assets/videos/classroom-session.mp4',
      poster: '/assets/images/gallery/gallery-3.png',
      title: 'Classroom Teaching Session',
      orientation: 'landscape',
    },
    {
      src: '/assets/videos/lab-experiment.mp4',
      poster: '/assets/images/gallery/gallery-1.png',
      title: 'Hands-On Lab Experiment',
      orientation: 'landscape',
    },
    {
      src: '/assets/videos/student-activity.mp4',
      poster: '/assets/images/gallery/gallery-4.png',
      title: 'Student Activities & Engagement',
      orientation: 'landscape',
    },
    {
      src: '/assets/videos/campus-life.mp4',
      poster: '/assets/images/banner/banner-5.png',
      title: 'A Day in Campus Life',
      orientation: 'landscape',
    },
    {
      src: '/assets/videos/academy-highlights.mp4',
      poster: '/assets/images/banner/banner-3.png',
      title: 'Academy Highlights & Achievements',
      orientation: 'landscape',
    },
    {
      src: '/assets/videos/campus-tour.mp4',
      poster: '/assets/images/banner/banner-4.png',
      title: 'Virtual Campus Tour',
      orientation: 'landscape',
    },
    {
      src: '/assets/videos/daily-assembly.mp4',
      poster: '/assets/images/gallery/gallery-5.png',
  ...
  seo: {
    ...
    ogImage:     '/assets/images/banner/banner-3.png',
  ...
  services: [
    {
      ...
      bannerSrc: '/assets/images/services/quran-classes.png',
    ...
    },
    {
      ...
      bannerSrc: '/assets/images/services/coaching-centre.png',
    ...
    },
    {
      ...
      bannerSrc: '/assets/images/services/personality-dev.png',
